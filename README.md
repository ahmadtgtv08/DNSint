...
- Discover email security misconfigurations
- Map infrastructure and nameservers

### Security Auditing
- Validate DNSSEC implementation
- Check DNS propagation consistency
- Audit email authentication (SPF/DMARC/DKIM)
- Scan for common DNS misconfigurations

### System Administration
- Monitor DNS changes over time
- Verify DNS updates across resolvers
- Test split-brain DNS configurations
- Document domain infrastructure

### OSINT & Reconnaissance
- Discover related domains and subdomains
...
DNSint includes a built-in auto-update feature:
...
3. Automatically update to the latest release
4. Remind you to reinstall dependencies if needed

**Note:** Auto-update only works if you cloned the repository with `git clone`.
...
- Enhanced report formats (HTML, PDF)
...
- ✅ WHOIS lookup with expiration tracking
...
- Built with [dnspython](https://github.com/rthalley/dnspython)
...
- **Issues:** [GitHub Issues](https://github.com/who0xac/DNSint/issues)

### Support the Project

If you find DNSint useful, consider:
